...
const features = [
  {
    ...
    description:
      "Quotes, scopes of work, and completion reports written by Claude AI — specific to your job, not a generic template.",
  },
  {
    icon: "📋",
    title: "Job Queue",
...
const steps = [
  ...
  },
  {
    ...
    description:
      "One button sends your full assessment to Claude AI. It writes the document — specific to your job, not a generic template.",
  },
  {
    number: "03",
  ...
  return (
    <div className="bg-[#0D0D0D]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-[#888888] text-lg leading-relaxed mb-8 max-w-lg">
                ...
                quote, scope of work, or completion report — generated by AI,
      ...
      <section className="py-24 border-t border-[#2A2A2A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="border border-[#FF6B35]/30 bg-[#FF6B35]/5 rounded-2xl p-8 sm:p-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                <div className="text-[#FF6B35] text-sm font-semibold mb-2">
                  For new operators
                </div>
                <h2 className="text-white text-2xl sm:text-3xl font-black mb-3">
                  Starting a biohazard cleaning business?
                </h2>
                <p className="text-[#888888] max-w-lg">
                  The 30-Day Bio-Business Accelerator takes you from zero to
                  your first paid job — with biohazards.net as your operating
                  system from day one.
                </p>
              </div>
              <Link
                href="/accelerator"
                className="shrink-0 bg-[#FF6B35] hover:bg-[#e55a26] text-white font-bold px-6 py-3 rounded-lg transition-colors whitespace-nowrap"
              >
                Learn More
              </Link>
            </div>
