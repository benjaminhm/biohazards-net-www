...
export const metadata: Metadata = {
  ...
  title: {
    default: "biohazards.net — Job Management & Automated Documents for Biohazard Operators",
  ...
  twitter: {
    ...
    description: "Automated job management for biohazard cleaning operators.",
  },
  robots: {
    index: true,
    follow: true,
